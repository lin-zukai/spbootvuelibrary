    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: "shouyitongji",
                name: "shouyitongji",
                component: () => import("@/views/total/shouyitongji"),
                meta: { authLogin: true, title: "统计" },
                props: (route) => ({ src: route.query.src }),
            },,
            {
                path: "shouyitongjifaburen",
                name: "shouyitongjifaburen",
                component: () => import("@/views/total/shouyitongjifaburen"),
                meta: { authLogin: true, title: "统计" },
                props: (route) => ({ src: route.query.src }),
            },,
            {
                path: "shouyitongjijieyueren",
                name: "shouyitongjijieyueren",
                component: () => import("@/views/total/shouyitongjijieyueren"),
                meta: { authLogin: true, title: "统计" },
                props: (route) => ({ src: route.query.src }),
            },
            ...AdminRoutes,
