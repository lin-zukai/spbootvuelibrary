<template>
    <div class="tushuguanliyuan-add" v-loading="loading">
        <el-card class="box-card">
            <div slot="header" class="clearfix updt">
                <el-page-header @back="$router.go(-1)" content="编辑图书管理员"> </el-page-header>
            </div>
            <div class="form-database-form">
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    <el-form-item
                        ...
                        prop="zhanghao"
                        required
                        :rules="[{required:true, message:'请填写账号'}, {validator:rule.checkRemote, message:'内容重复了', checktype:'update', module:'tushuguanliyuan', col:'zhanghao', id:form.id, trigger:'blur'}]"
                    >
    ...
    export default {
        ...
        methods: {
            submit() {
                this.$refs.formModel
                    ...
                    .then((res) => {
                        ...
                        this.$post(api.tushuguanliyuan.update, form)
                            .then((res) => {
                                this.loading = false;
            ...
            loadInfo() {
                ...
                this.loading = true;
                var form = this.form;
                this.$post(api.tushuguanliyuan.edit, {
                    id: this.id,
                })
                    .then((res) => {
                        this.loading = false;
