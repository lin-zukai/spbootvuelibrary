            ...
            <div class="form-database-form">
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    <el-form-item
                        ...
                        prop="zhanghao"
                        required
                        :rules="[{required:true, message:'请填写账号'}, {validator:rule.checkRemote, message:'内容重复了', checktype:'insert', module:'tushuguanliyuan', col:'zhanghao', trigger:'blur'}]"
                    >
    ...
    export default {
        ...
        methods: {
            submit() {
                this.$refs.formModel
                    ...
                    .then((res) => {
                        ...
                        this.$post(api.tushuguanliyuan.insert, form)
                            .then((res) => {
                                this.loading = false;
            ...
            loadInfo() {
                ...
                // 获取模块得数据
                this.loading = true;
                this.$post(api.tushuguanliyuan.create, {
