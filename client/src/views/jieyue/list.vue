<template>
    <div class="v-list" v-loading="loading" element-loading-text="加载中">
        <el-card class="box-card">
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            ...
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/jieyueupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
            ...
            <div>借阅金额总和: {{ total.sum_jieyuejine }}</div>
        </el-card>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.jieyue.list, filter)
                    .then((res) => {
                        this.loading = false;
