        ...
        <el-card class="box-card">
            ...
            <div class="form-search">
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    ...
                    <el-form-item label="举报人">
                        <el-input v-model="search.jubaoren"></el-input>
                    </el-form-item>
                    <el-form-item label="处理备注">
                        <el-input v-model="search.chulibeizhu"></el-input>
                    </el-form-item>
                    <el-form-item label="处理人">
                        <el-input v-model="search.chuliren"></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="举报人" width="80">
                    <template slot-scope="{row}"> {{ row.jubaoren }} </template>
                </el-table-column>
                <el-table-column label="处理备注">
                    <template slot-scope="{row}"> {{ row.chulibeizhu }} </template>
                </el-table-column>
                <el-table-column label="处理人" width="80">
                    <template slot-scope="{row}"> {{ row.chuliren }} </template>
                </el-table-column>
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/jubaochulidetail',query:{id:row.id } })" icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/jubaochuliupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.jubaochuli.listchuliren, filter)
                    .then((res) => {
                        this.loading = false;
            ...
            deleteItem(row) {
                this.$confirm("确定删除数据？", "提示", {
                    ...
                    .then(() => {
                        ...
                        this.$post(api.jubaochuli.delete, {
                            // 提交后台
                            id: row.id,
                        })
                            .then((res) => {
