                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-tooltip content="回复" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/liuyanbanupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/liuyanbandetail',query:{id:row.id } })" icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
