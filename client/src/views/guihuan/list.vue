    ...
    <div class="v-list" v-loading="loading" element-loading-text="加载中">
        <el-card class="box-card">
            ...
            <div class="form-search">
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    ...
                    <el-form-item label="还书人">
                        <el-input v-model="search.huanshuren"></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="实际归还时间" width="120">
                    <template slot-scope="{row}"> {{ row.shijiguihuanshijian }} </template>
                </el-table-column>
                <el-table-column label="备注">
                    <template slot-scope="{row}"> {{ row.beizhu }} </template>
                </el-table-column>
                <el-table-column label="还书人" width="80">
                    <template slot-scope="{row}"> {{ row.huanshuren }} </template>
                </el-table-column>
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/guihuandetail',query:{id:row.id } })" icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/guihuanupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.guihuan.list, filter)
                    .then((res) => {
                        this.loading = false;
