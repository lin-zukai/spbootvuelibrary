<template>
    <div class="guihuan-detail" v-loading="loading" ref="print">
        <el-page-header @back="goBack" content="详情页面"></el-page-header>
        <div class="admin-detail">
            <div class="detail detail-readmodule">
                <div class="detail-title">借阅id：</div>
                <div class="detail-content">{{ map.jieyueid }}</div>
            </div>
            <div class="detail detail-readmodule">
            ...
            <div class="detail detail-textuser">
                <div class="detail-title">还书人：</div>
                <div class="detail-content">{{ map.huanshuren }}</div>
            </div>
            <div class="detail detail-datetime">
                <div class="detail-title">实际归还时间：</div>
                <div class="detail-content">{{ map.shijiguihuanshijian }}</div>
            </div>
