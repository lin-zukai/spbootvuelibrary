<template>
    <div class="tushuxinxi-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-select">
                <div class="detail-title">图书状态：</div>
                <div class="detail-content">{{ map.tushuzhuangtai }}</div>
            </div>
            ...
            <div class="detail detail-money">
                <div class="detail-title">借阅预赔金：</div>
                <div class="detail-content">{{ map.jieyueyupeijin }}</div>
            </div>
            <div class="detail detail-money">
            ...
            <div class="detail detail-number">
                <div class="detail-title">借阅次数：</div>
                <div class="detail-content">{{ map.jieyuecishu }}</div>
            </div>
            ...
            <div class="detail detail-video">
                <div class="detail-title">视频：</div>
                <div class="detail-content">
                    <e-video :src="map.shipin"></e-video>
                </div>
            </div>
            <div class="detail detail-editor">
                <div class="detail-title">图书详情：</div>
                <div class="detail-content">
                    <div v-html="map.tushuxiangqing"></div>
                </div>
            </div>
        </div>
        <div class="mt10">
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail() {
                ...
                this.loading = true;
                this.$get(api.tushuxinxi.detail, {
                    id: this.id,
                })
                    .then((res) => {
                        this.loading = false;
