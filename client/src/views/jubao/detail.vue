<template>
    <div class="jubao-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-text">
                <div class="detail-title">举报状态：</div>
                <div class="detail-content">{{ map.jubaozhuangtai }}</div>
            </div>
            ...
            <div class="detail detail-textarea">
                ...
                <div class="detail-content">{{ map.jubaoneirong }}</div>
            </div>
        </div>
        <div class="mt10">
