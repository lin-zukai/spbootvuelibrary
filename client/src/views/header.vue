            ...
            <e-container class="clearfix">
                ...
                <div class="header-nav-ul nav-left clearfix">
                    <ul class="header-nav-left clearfix">
                        ...
                        <li>
                            <router-link to="/tushuxinxi"
                                >图书信息
                                <i class="el-icon-arrow-down"></i>
                            </router-link>
                            <ul class="submenu">
                                <li v-for="m in listMenutushufenlei">
                                    <router-link :to="'/tushuxinxi?tushufenlei='+m.id" v-text="m.fenleimingcheng"></router-link>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <router-link to="/liuyanbanadd">在线留言 </router-link>
                        </li>
                        <li>
...
<script>
    ...
    export default {
        ...
        created() {
            this.loadListMenu("tushufenlei", "listMenutushufenlei");
        },
        mounted() {},
        destroyed() {},
    };
